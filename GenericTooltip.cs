...
public class GenericTooltip : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
	...
	public bool overridePoolValues;
	public float waitDelay, fadeIn, fadeOut;

	public bool activeTip { get; private set; }

	[HideInInspector] public bool lockedFromOpenClose;
	...
	/**Call the tooltip! Puts it to the left of the object, as a child.
     */
	public void OpenTooltip()
	{
		//Make sure we can see it (Tooltips allowed, not locked, correct layer)
		if (PlayerPrefs.GetInt("Tooltips") == 1 && !lockedFromOpenClose && (GameReference.r == null || overlayTip == GameReference.r.overlayActive))
		{
